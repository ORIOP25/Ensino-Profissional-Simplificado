...
def main(prompt):
    try:
        ...
        print(json.dumps({'response': response.choices[0].message.content.strip()}, ensure_ascii=False))
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        print(json.dumps({'error': 'No prompt provided'}, ensure_ascii=False), file=sys.stderr)